  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="text-1xl bg-zinc-100 w-1/2 rounded p-3 mb-3"
      ...
      <div className="w-1/2 flex justify-between">
        <input
          ...
          className="text-1xl bg-zinc-100 w-[48%] rounded p-3 mb-3"
      ...
      <textarea
        className="text-1xl bg-zinc-100 w-1/2 rounded p-3 mb-3"
        placeholder="Enter Product Description hear..."
      ...
      <div className="w-1/2">
        <button className="py-2 px-5 border rounded hover:bg-blue-200 hover:text-black duration-[0.3s]  border-blue-200 text-blue-300">
          Add new product
        </button>
      </div>
    </form>
